...
| **Região** | `Shift+PrtScr` | Congela a tela, você arrasta um retângulo e ele vai direto para a área de transferência, pronto para colar (`Esc` cancela). `Space` alterna para escolher uma **janela** inteira, `Ctrl+A` pega o monitor todo |
